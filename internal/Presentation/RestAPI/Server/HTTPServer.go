...
import (
	...
	"WB2/internal/Presentation/RestAPI/Parser/Factory"
	"encoding/json"
	"log"
	"net/http"
)
...
func NewHTTPServer(userEventsRepo Repos.IUserEventsRepo) *HTTPServer {
	getService := UserService2.CreateGetService(userEventsRepo)
	postService := UserService2.CreatePostService(userEventsRepo)
